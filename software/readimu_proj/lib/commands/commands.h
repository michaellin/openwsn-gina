...
#define CMD_RAW           1
#  define CMD_RAW_IMU     10
#  define CMD_RAW_IMG     20
...
#  define CMD_MODE_SENDRECVCHAN   13
#  define CMD_MODE_SENDSNIFF      14
#  define CMD_MODE_PERIPH_TEST    10
#  define CMD_MODE_PERIPH_ENABLE  11
#  define CMD_MODE_IMU_LOOP       20
#  define CMD_MODE_GET_IMU        21
#  define CMD_MODE_SNAPSHOT       30
#  define CMD_MODE_VIDEO          31
#  define CMD_MODE_COMBINED       40
#  define CMD_MODE_AVERAGE        70
#  define CMD_MODE_CTRL_LOOP      71
  char cmd_mode;
...
#define CMD_BUILDRAWPKT     10
#define CMD_SENDRAWPKT      11

#define CMD_SETCONTROLS   20
#define CMD_ADDHOP        50
  
#define CMD_SETGAINS      70
