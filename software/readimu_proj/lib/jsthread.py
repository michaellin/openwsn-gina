...
class rc:
  ...
  def __init__(self, bias=[0,0,0,0], scale=[1,1,1,1]):
    pygame.init()
  ...
  def go(self):
    ...
    if self.j.get_button(5):
      if not self.rcbuttons[5]:
        self.rcbias[0] = self.rcval[0] # self.rcdata[0] + self.rcbias[0]
        self.rcbias[1] = self.rcval[1] # self.rcdata[1] + self.rcbias[1]
    ...
    if self.j.get_button(4):
      if not self.rcbuttons[4]:
        self.rcbias[2] = self.rcval[2] # self.rcdata[2] + self.rcbias[2]
        self.rcbias[3] = self.rcval[3] # self.rcdata[3] + self.rcbias[3]
        # print repr(self.rcbias)
      self.rcdata[2] = 0
      self.rcdata[3] = 0
    ...
    if self.j.get_button(6) and not self.rcbuttons[6]:
      self.num = self.num / 2.0;
      # print self.num
    if self.j.get_button(7) and not self.rcbuttons[7]:
      self.num = self.num * 2.0;
      # print self.num
