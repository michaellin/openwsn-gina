#From: /../GINA/Spring 2013/Gina Stuff (Joey)/readimu_v6 (2).py
#see readimu_v7.py in the "Gina Stuff (Joey)" directory
...
#It will also log the data collected from the ring onto a .txt file
...
if __name__=="__main__":
    ...
    chan1 = "15" #raw_input('Channel to sniff \n')
    ...
    #m1 = motetalk.motetalk("xH","n",sport,None)
    #from getdata.py
    m1 = motetalk.motetalk(sport=sport,brate=115200)
